...
> * 🛠️ **코어 개발자 & 기여자:** 자율 데몬 엔진(`aerd`) 구현 청사진과 단계별 개발 명세를 담은 **[ROADMAP.ko.md (구현 로드맵)](ROADMAP.ko.md)** / **[ROADMAP.md (English)](ROADMAP.md)**를 확인하세요.
...
## 🏛️ 번외 (Appendix) : 현실 금융과의 접점, 테더 스왑과 거시경제학적 딜레마
