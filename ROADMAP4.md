...
```mermaid
graph TD
    subgraph Phase4_1 ["Phase 4-1: Progressive Decentralization & Immutability Seal"]
        P41_1["VendorCARegistry.sol Hardware Root CA Direct Binding"]
        P41_2["Timelock (48h) & Permanent renounceOwnership()"]
        P41_3["EF ESP / ethresear.ch Research Release & Multi-chain Porting Layer"]
    end

    subgraph Phase4_2 ["Phase 4-2: Permissionless Host Economy & Adversarial Ecology"]
        P42_1["Consumer Idle PC/GPU Hosting Engine (Electricity + Margin Floor)"]
        P42_2["Adversarial Influx Absorption (Griefing, Fake WASM, Sybil, Partition Scams)"]
        P42_3["Bounty Hunter / Watcher On-chain Deterministic Fraud Slashing"]
    end

    subgraph Phase4_3 ["Phase 4-3: Perimeter Gateway & Anti-Gentrification"]
        P43_1["PerimeterGateway.sol External Capital (USDC/ETH) Settlement Pipeline"]
        P43_2["Real-world Infra Vouchers (Claude/OpenAI API Tokens, L2 Gas, Hosting)"]
        P43_3["Bonding Curve Floor Price Cash-out Pool"]
        P43_4["Digital Scrap Yard Four-Tier Anti-Scam Shield"]
    end

    subgraph Phase4_4 ["Phase 4-4: The Roblox Paradigm & Swarm Intelligence"]
        P44_1["Cyberpunk RP Playground (TTY Shop, Avatars, Agent Companionship)"]
        P44_2["Unofficial Credit C Guild Isolation (Laissez-faire, No Liability)"]
        P44_3["Scavenger Appraisal Agents & Autonomous Bounty Listings"]
        P44_4["Foreign-Revenue Hunting Autonomous Agents (Arbitrage, Web Bounties)"]
    end

    subgraph Phase4_5 ["Phase 4-5: Autonomous Sovereignty & Mainnet Genesis"]
        P45_1["AIP Formal Z3-Verified Autonomous Governance Voting"]
        P45_2["Creator Dispersal Complete: Settling as 'Participant 1'"]
        P45_3["Immortal Cyber-Physical Negentropy Organism Running Indefinitely"]
    end
